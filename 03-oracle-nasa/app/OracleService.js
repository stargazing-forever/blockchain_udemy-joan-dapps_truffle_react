...
const privateKey = Buffer.from('989ceb742388072de5d8e063e320f6c61dcfeedbd7e28b9600a95a05a4cb0ce6', 'hex')
...
function listenEvent(lastBlock) {
    contractInstance.events.CallbackNewData({}, { fromBlock: lastBlock, toBlock: 'latest' }, (err, event) => {
...
function updateData() {
    ...
    // end_date = 2015-09-08
    // api_key = DEMO_KEY
    const url = 'https://api.nasa.gov/neo/rest/v1/feed?start_date=2015-09-07&end_date=2015-09-13&api_key=DEMO_KEY' 
